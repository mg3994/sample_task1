...
Container biddingRideListWidget(Size size, BuildContext context) {
  return Container(
              ...
              SizedBox(
                ...
                child: Slider(
                    ...
                    max: context.read<HomeBloc>().distanceBetweenList[
                        context.read<HomeBloc>().distanceBetweenList.length -
                            1]['dist'],
                    divisions:
                        context.read<HomeBloc>().distanceBetweenList.length,
                    activeColor: AppColors.primary,
                    inactiveColor: AppColors.secondary,
                    value: context.read<HomeBloc>().distanceBetween ?? 0.0,
                    onChanged: (v) {
                      if (v > 0.0) {
                        context
                            .read<HomeBloc>()
              ...
              SizedBox(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    for (var i = 0;
                        i < context.read<HomeBloc>().distanceBetweenList.length;
                        i++)
                      MyText(
                        text:
                            ...
                            Container(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  (stops.isEmpty &&
                                          context.read<HomeBloc>().rideList[key]
                                                  ['drop_address'] !=
                                              '')
                                      ? Column(
                                          children: [
                                        ...
                                        CustomButton(
                                          ...
                                          onTap: () {
                                            context.read<HomeBloc>().add(ShowBidRideEvent(
                                                ...
                                                pickLat: context
                                                    .read<HomeBloc>()
                                                    .rideList[key]['pick_lat'],
                                                pickLng: context
                                                    .read<HomeBloc>()
                                                    .rideList[key]['pick_lng'],
                                                dropLat: context
                                                    .read<HomeBloc>()
                                                    .rideList[key]['drop_lat'].toDouble(),
                                                dropLng: context
                                                    .read<HomeBloc>()
                                                    .rideList[key]['drop_lng'].toDouble(),
                                                stops: stops,
                                                pickAddress:
                                                    context.read<HomeBloc>().rideList[key]
                                                        ['pick_address'],
                                                ...
                                                acceptedRideFare: context.read<HomeBloc>().rideList[key]['price']));
                                          },
                                          width: size.width * 0.32,
