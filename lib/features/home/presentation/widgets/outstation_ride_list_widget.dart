...
Widget biddingoutStationListWidget(Size size, BuildContext context) {
  return SafeArea(
    child: Container(
              ...
              children: [
                ...
                Expanded(
                  child: SingleChildScrollView(
                    child: (context.read<HomeBloc>().outStationList.isNotEmpty)
                        ? Column(
                            children: context
                                .read<HomeBloc>()
                                .outStationList
                                ...
                                .map((key, value) {
                                  ...
                                  double dist = calculateDistance(
                                    ...
                                    lat2: context
                                        .read<HomeBloc>()
                                        .outStationList[key]['pick_lat'],
                                    lon2: context
                                        .read<HomeBloc>()
                                        .outStationList[key]['pick_lng'],
                                  );
                                  return MapEntry(
                                      key,
                                      InkWell(
                                        onTap: () {
                                          context.read<HomeBloc>().add(ShowBidRideEvent(
                                              ...
                                              dropLat: context.read<HomeBloc>().outStationList[key]
                                                  ['drop_lat'],
                                              dropLng: context.read<HomeBloc>().outStationList[key]
                                                  ['drop_lng'],
                                              stops: stops,
                                              pickAddress: context
                                                      .read<HomeBloc>()
                                                          ...
                                                          if (context
                                                            ...
                                                            Row(
                                                              ...
                                                              children: [
                                                                ...
                                                                MyText(
                                                                  text:
                                                                      '${context.read<HomeBloc>().outStationList[key]['completed_ride_count']} ${AppLocalizations.of(context)!.trips}',
                                                                  textStyle: Theme.of(
                                                                          context)
                                                                      .textTheme
                                                                      .bodySmall!
